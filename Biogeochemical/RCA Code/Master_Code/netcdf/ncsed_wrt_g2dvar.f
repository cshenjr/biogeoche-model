      SUBROUTINE ncsed_wrt_g2dvar(ncID,idvar,Vvalue)
!
!=======================================================================
...
!-----------------------------------------------------------------------
!
      SUBNA=TRIM(ADJUSTL(RCANA))//' when CALL ncsed_wrt_g2dvar.f'
!
!----------------------------------------------------------------------
...
!
      ...
      ELSE
        WRITE(OUT,*) 'ERROR: misuse of ncsed_wrt_g2dvar.f ',
...
! put values
     ...
     .                    count=mcount)
      ...
      END SUBROUTINE ncsed_wrt_g2dvar
