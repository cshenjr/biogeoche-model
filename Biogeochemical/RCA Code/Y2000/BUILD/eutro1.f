...
!      REAL, ALLOCATABLE, DIMENSION(:,:,:) :: TDIAG10, TDIAG11 
     ...
     .   ,GDIAG3,GDIAG4,GDIAG5,GDIAG6,GDIAG7,GDIAG12,GDIAG13 
	  REAL, ALLOCATABLE, DIMENSION(:,:) :: GDIAG8, GDIAG9,GDIAG10
     .   ,GDIAG11,GDIAG14  
!!============================================================
...
! salinity, tic, ta, phosphate and silica required for partial pressure calculation	  
	    SN = MAX(SAL(IX,IY,1),0.1)
		TICN = REDOC(IX,IY,1)
		TALKN = REPOC(IX,IY,1)
		PO4N = PO4T(IX,IY,1)/31*1000
		SIO3N = SIT(IX,IY,1)/28*1000
		
	    CALL PCO2_WATER(HYDTEMP(IX,IY,1),SN,TICN,
...
!        CALL ncwrt_g3dvar(ncID_dia,iddia_ALG2SET,TDIAG11)
        ...
        CALL ncwrt_g2dvar(ncID_dia,iddia_POC2,GDIAG8)
